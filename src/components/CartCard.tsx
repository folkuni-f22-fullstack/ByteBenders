...
function CartCard() {
	...
	function promoCode() {
		if (isPromo === 'discount20%') {
			const discount = (totalPrice.value / 100) * 20;
			const newPrice = Math.round(totalPrice.value - discount);
				...
				<div className='cart-card-container'>
					{cartCopy.length === 0 && !currentOrder.isOrdered ? (
						<div className='empty-cart-div'>
							...
							<p className='empty-p'>
								Looks like you haven't added anything to the
								cart yet.
							</p>
						</div>
					) : (
